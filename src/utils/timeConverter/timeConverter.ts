import compareTime from 'src/utils/timeConverter/compareTime';

export default function timeConverter(timeStamp: string) {
  const [diffSeconds, createdTime] = compareTime(timeStamp);
